...
describe('Calculator Component', () => {
  ...
  test('performs subtraction operation', () => {
    ...
    fireEvent.change(screen.getByLabelText('Number 1'), { target: { value: '8' } });
    fireEvent.change(screen.getByLabelText('Number 2'), { target: { value: '3' } });
  ...
  test('performs multiplication operation', () => {
    ...
    fireEvent.change(screen.getByLabelText('Number 1'), { target: { value: '4' } });
    fireEvent.change(screen.getByLabelText('Number 2'), { target: { value: '5' } });
  ...
  test('handles invalid input for division operation', () => {
    ...
    fireEvent.change(screen.getByLabelText('Number 1'), { target: { value: '10' } });
    fireEvent.change(screen.getByLabelText('Number 2'), { target: { value: '0' } });
    fireEvent.click(screen.getByText('Divide'));
 
    expect(screen.getByText(/Result: (Infinity|Invalid input)/)).toBeInTheDocument();
  ...
  test('handles empty input and sets result to "Invalid input"', () => {
    ...
    fireEvent.change(screen.getByLabelText('Number 1'), { target: { value: '5' } });
    fireEvent.change(screen.getByLabelText('Number 2'), { target: { value: '' } });
    fireEvent.click(screen.getByText('Add'));
